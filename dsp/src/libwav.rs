...
pub trait WavReaderTrait {
    ...
    fn get_sample_format(&self) -> WavSampleFormat;
    fn get_sample_count(&mut self) -> Result<u64, io::Error>;
    fn get_samples_read(&mut self) -> Result<u64, io::Error>;
    fn read_samples(&mut self, arr: &mut [f32]) -> Result<(), io::Error>;
    fn read_complex(&mut self, arr: &mut [Complex<f32>]) -> Result<(), io::Error>;
}
...
impl<R: io::Read + io::Seek> WavReaderTrait for Reader<R> {
    fn get_channels(&self) -> u16 {
        self.info.channels
    }
